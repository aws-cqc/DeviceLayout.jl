...
# Delete LocalPreferences.toml generated by Preferences test set in tests.jl, otherwise
# this test set fails if run more than once
rm(abspath(joinpath(@__DIR__, "..", "LocalPreferences.toml")))
